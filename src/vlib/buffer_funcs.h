...
typedef void (vlib_buffer_enqueue_to_single_next_with_aux64_fn_t) (vlib_main_t *vm,
								   vlib_node_runtime_t *node,
								   u32 *ers, u64 *aux_data,
								   u16 next_index, u32 count);
typedef void (vlib_buffer_enqueue_to_single_next_with_aux64_and_scalar_fn_t) (
...
typedef struct
{
  ...
  vlib_buffer_enqueue_to_single_next_with_aux64_fn_t *buffer_enqueue_to_single_next_with_aux64_fn;
