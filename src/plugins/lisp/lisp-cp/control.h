...
typedef enum
{
  LISP_CP_INPUT_ERROR_DROP,
  LISP_CP_INPUT_ERROR_NO_BUFFERS,
  ...
  LISP_CP_INPUT_ERROR_MAP_REPLIES_RECEIVED,
  LISP_CP_INPUT_N_ERROR,
} lisp_cp_input_error_t;

typedef enum
{
  LISP_CP_LOOKUP_ERROR_DROP,
  LISP_CP_LOOKUP_ERROR_NO_BUFFERS,
  LISP_CP_LOOKUP_ERROR_MAP_REQUESTS_SENT,
  LISP_CP_LOOKUP_ERROR_ARP_REPLY_TX,
